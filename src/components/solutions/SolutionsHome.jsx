...
const SolutionsHome = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-gray-900 to-black text-white ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 p-5 sm:p-10">
        {names.map((name, index) => (
          ...
          >
            <div
              className="bubble flex items-center justify-center text-base sm:text-lg lg:text-xl font-bold shadow-xl hover:shadow-2xl transition-transform duration-300 transform hover:scale-110 bg-gray-800 rounded-full w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 border-0 border-transparent hover:border-white"
              style={{
                fontFamily: "Montserrat, sans-serif",
                textShadow:
                  "0 0 5px rgba(255, 255, 255, 0.8), 0 0 10px rgba(255, 255, 255, 0.6)", // Glow effect
                letterSpacing: "1px",
                fontSize: "1.5rem",
